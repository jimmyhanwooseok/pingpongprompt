                ...
                {importFormat === 'simple' ? (
                  <>
                    ...
                    <div style={{fontSize: '12px', backgroundColor: '#f8f9fa', padding: '10px', borderRadius: '4px', marginBottom: '10px'}}>
                      <strong>📊 간단한 형식 예시 (Excel 스타일):</strong>
                      <pre style={{margin: '5px 0', fontSize: '11px', overflow: 'auto'}}>{`템플릿 이름	설명	고정된 내용 {{{변수}}}	용도	회기	아동유형
체크인 미니특공대	체크인 문장	안녕 {{{이름}}}! 볼트처럼 변신하고 싶어?	체크인	1회기	소극형
역할놀이	설명	"# Variables
{
	""이름"": ""주원"",
	""상대"": ""{{{아동이름}}}"",
...
# Role & Objective
- 너는 {{{아동나이}}}살 남자 아이 주원이야.
- 상대는 너랑 동갑이며 {{{아동성별}}} 아이 {{{아동+야/이야}}}.
- 목표: 그네를 새치기했는데 타고 싶은 마음에 거짓말을 하다가, 미안함으로 사과하고 나중에는 함께 노는 것.
"	자유대화	1회기	소극형`}</pre>
                      <p style={{fontSize: '11px', margin: '5px 0', color: '#666'}}>
                        💡 Excel에서 복사하면 자동으로 탭(	)으로 구분됩니다!<br/>
                        💡 내용이 여러 줄이면 그냥 붙여넣으세요! 자동으로 하나의 템플릿으로 저장됩니다!<br/>
                        💡 용도, 회기, 아동유형은 비워도 됩니다!
                      </p>
                    </div>
                  </>
